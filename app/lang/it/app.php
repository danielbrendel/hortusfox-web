...
return [
	...
	'enter_password_confirmation' => 'Conferman la password',
	'login' => 'Accedi',
	'logout' => 'Esci',
	'user_not_found' => 'Utente non trovato: {email}',
	'password_mismatch' => 'Le passwords non coincidono',
	'password' => 'Password',
	'password_confirmation' => 'Password (conferma)',
	'restore_password' => 'Recupera password',
	'restore_password_info' => 'La preghiamo di seguire le istruzioni inviate al suo account e-mail.',
	'reset_password' => 'Reimposta password',
	'reset_password_hint' => 'La preghiamo di andare al seguente link per reimpostare la sua password per accedere a {workspace}: <a href="{url}">Reimposta password</a>',
	'dashboard' => 'Schermata iniziale',
	'welcome_message' => 'Ciao {name}, ben tornato!',
	'locations' => 'Posizioni',
	...
	'last_repotted' => 'Ultimo travaso',
	'last_fertilised' => 'Ultima fertilizzazione',
	'perennial' => 'Perenne', //forse è meglio "perennante"
	'annual' => 'Annuale',
	'cutting_month' => 'Mese del taglio',
	'date_of_purchase' => 'Data di acquisto',
	'humidity' => 'Umidità',
	'light_level' => 'Livello di luce',
	'health_state' => 'Stato di salute',
	'in_good_standing' => 'in buono stato',
	'overwatered' => 'Troppo irrigata',
	'withering' => 'Appassimento',
	'infected' => 'Infetta',
	'pest_infestation' => 'Infetta da parassita',
	'transplant_shock' => 'Shock da trapianto',
	'nutritional_deficiency' => 'Deficit nutritivo', //nutrizionale
	'sunburn' => 'Scottatura solare', //sunburn
	'frostbite' => 'Danno da gelo', //cercare traduzione migliore per frostbite
	'root_rot' => 'Marcescenza radicale', //cercare traduzione migliore per root rot
	'plant_warning' => 'Attenzione: Questa pianta richiede un monitoraggio particolare. Motivo: {reason}',
	'notes' => 'Note',
	'no_notes_specified' => 'Non ci sono note ancora specifiche',
	'select_month' => '- Seleziona il mese -',
	'select_light_level' => '- Seleziona il livello di luce -',
	'january' => 'Gennaio',
	'february' => 'Febbraio',
	'march' => 'Marzo',
	'april' => 'Aprile',
	...
	'yes' => 'Sì',
	'no' => 'No',
	'back_to_list' => 'Ritorna alla lista',
	'back_to_dashboard' => 'Ritorna  alla dashboard', //cercare traduzione migliore per dashboard
	'name' => 'Nome',
	'email' => 'E-Mail',
	'photo' => 'Foto',
	'add' => 'Aggiungi',
	...
	'light_level_half_shade' => 'Penombra',
	'light_level_full_shade' => 'Ombra',
	'warning_plants_title' => 'La seguente pianta richiede speciale attenzione',
	'warning_plants_all_ok' => 'Evviva! Non ci sono piante a rischio',
	'view_plant_details' => 'Vedi i dettagli della pianta',
	'log_title' => 'Log',
	'loading_please_wait' => 'Si prega di attendere...',
	'error' => 'Errore',
	'photos' => 'Foto',
	'no_photos_yet' => 'Al momento non ci sono foto caricate aggiuntive',
	'upload' => 'Carica',
	'upload_photo' => 'Carica foto',
	'label' => 'Etichetta',
	'confirmPhotoRemoval' => 'Si è sicuri di voler rimuovere questa foto?', //frase neutra
	'users' => 'Utenti',
	'photo_uploaded_successfully' => 'La foto è stata caricata con successo',
	'success' => 'Successo',
	'profile' => 'Profilo',
	'profile_hint' => 'Accesso efettuato come {name} ({email})',
