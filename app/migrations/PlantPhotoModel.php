...
/**
 * Class PlantPhotoModel_Migration
 */
class PlantPhotoModel_Migration {
    ...
    public function up()
    {
        $this->database = new Asatru\Database\Migration('PlantPhotoModel', $this->connection);
        $this->database->drop();
        ...
        $this->database->add('original VARCHAR(512) NOT NULL');
